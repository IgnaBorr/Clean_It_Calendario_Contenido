...
const APP_BUILD = 'roles-calendario-usuarios-202605';
...
let state = { companies: [], items: [], assets: [], prospects: [], profiles: [], access: [] };
let isBusy = false;
...
async function loadAll(){
  ...
  const [companies, items, assets, profiles, access, prospects] = await Promise.all(promises);
