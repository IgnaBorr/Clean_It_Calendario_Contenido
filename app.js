...
function renderIdeas(){
  ...
  return `<div class="panel ideas-panel">
    <div class="panel-head">
      <div><div class="panel-title">Banco de ideas</div><div class="item-desc">Independiente del calendario. Las ideas pueden tener fecha opcional y mostrarse o no en el calendario.</div></div>
      <div class="panel-actions"><button class="btn ghost sm" onclick="generateLocalIdeas()"><i class="fa-solid fa-wand-magic-sparkles"></i> Generar ideas rápidas</button><button class="btn primary sm" onclick="openIdeaModal()"><i class="fa-solid fa-plus"></i> Nueva idea</button></div>
    </div>
...
function openIdeaModal(id=null){
  ...
  const body = `<form id="idea-form"><div class="form-grid">
    ...
    <div class="form-group"><label class="form-label">Canales tentativos</label><input class="form-input" name="channel" value="${escAttr(item?.channel||'')}" placeholder="Instagram, Reels, TikTok" /></div>
    <div class="form-group"><label class="form-label">Tipos tentativos</label><input class="form-input" name="content_type" value="${escAttr(item?.content_type||'')}" placeholder="Reel, historia, carrusel" /></div>
    <div class="form-group"><label class="form-label">Responsable</label><select class="form-input" name="owner">${ownerOptions(item?.owner||'')}</select></div>
